...
import { Container, Button, Typography, Grid, Snackbar, Alert } from '@mui/material';
						...
						>
							<Grid item xs={6} md={6}>
								...
								<div role='group' aria-labelledby='my-radio-group'>
									<label>
										<Field type='radio' name='user' id='patient' value='patient' />
										PATIENT
									</label>

									<label>
										<Field type='radio' name='user' value='doctor' id='doctor' />
										DOCTOR
									</label>
								</div>
							</Grid>
