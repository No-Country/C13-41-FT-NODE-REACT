    ...
    <DetailsContainer>
        ...
        <InsideContainer>
            ...
            <InputContainer>
                ...
                <DetailSpan id='fullname'>{props.fullname}<EditIcon onClick={changeFullName} /></DetailSpan>
            </InputContainer>

            <InputContainer>
                <DetailSpan>E-Mail:</DetailSpan>
                <DetailSpan id='email'>{props.email}<EditIcon onClick={changeEmail}/></DetailSpan>
            </InputContainer>

            <InputContainer>
                <DetailSpan>Birthdate:</DetailSpan>
                <DetailSpan id='birthdate'>{props.birthdate}<EditIcon onClick={changeBirthdate} /></DetailSpan>
            </InputContainer>

            <InputContainer>
                <DetailSpan>NID:</DetailSpan>
                <DetailSpan id='nid'>{props.nid}<EditIcon onClick={changeNID} /></DetailSpan>
            </InputContainer>
        ...
        <InsideContainer>
            ...
            <InputContainer>
                ...
                <DetailSpan id='country'>{props.country}<EditIcon onClick={changeCountry}/></DetailSpan>
            </InputContainer>
            ...
            <InputContainer style={{display: "flex", flexDirection: "column",}}>
                <DetailSpan>Profile Picture: <DetailSpan>{props.avatar}<EditIcon onClick={changeAvatar} /></DetailSpan></DetailSpan>
